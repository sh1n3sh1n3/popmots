// .wrangler/tmp/bundle-RuL6Rf/checked-fetch.js
...
// .wrangler/tmp/pages-dQ287m/functionsWorker-0.9661880082282561.mjs
...
async function onRequestGet({ env }) {
  ...
  return new Response(JSON.stringify(keys.results.map((key) => String(key.word))));
}
async function onRequestGet2({ params, env }) {
  ...
  if (word) {
    ...
    if (wordEntries) {
      const wordEntriesFormatted = wordEntries.results.map((entry) => {
        return {
          ...entry,
...
var routes = [
  {
    routePath: "/api/dictionary/keys",
    mountPath: "/api/dictionary",
    method: "GET",
    middlewares: [],
    modules: [onRequestGet]
  },
  {
    routePath: "/api/dictionary/:word",
    mountPath: "/api/dictionary",
    method: "GET",
    middlewares: [],
...
// .wrangler/tmp/bundle-RuL6Rf/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RuL6Rf/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9661880082282561.js.map
